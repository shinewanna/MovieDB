...
class _CommingSoonScreenState extends State<CommingSoonScreen> {
  ...
  CommingSoonBloc bloc;
  @override
  void initState() {
    super.initState();
    bloc = CommingSoonBloc();
    bloc.getCommingSoonMovie();
    refreshController = RefreshController();
    bloc.commingSoonStream().listen((rv) {
    ...
    bloc.moreCommingSoonStream().listen((rv) {
      if (rv.message == MsgState.data) {
